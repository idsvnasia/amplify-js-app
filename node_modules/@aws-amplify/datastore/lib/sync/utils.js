...
function isOwnerBasedModel(modelDefinition) {
    return (types_1.isSchemaModel(modelDefinition) &&
        modelDefinition.attributes &&
        modelDefinition.attributes.some(function (attr) {
            return attr.properties &&
                attr.properties.rules &&
                attr.properties.rules.some(function (rule) { return rule.allow === 'owner'; });
        }));
}
