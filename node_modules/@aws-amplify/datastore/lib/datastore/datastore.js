            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        this.sync = new sync_1.SyncEngine(schema, namespaceResolver, syncClasses, userClasses, this.storage, modelInstanceCreator, this.maxRecordsToSync, this.syncPageSize, this.conflictHandler, this.errorHandler, this.syncPredicates, this.amplifyConfig);
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        logger.debug('params ready', {
                            ...
                            pagination: __assign(__assign({}, pagination), { sort: predicates_1.ModelSortPredicateCreator.getPredicates(pagination.sort, false) }),
                        });
